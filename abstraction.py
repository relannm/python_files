...
#   -> means each object should only expose high level mechanism for using it
#   -> hide internal details
#   EX: HR's concern should only be about setting and getting salary, not the computations and internal processing
